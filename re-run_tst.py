...
cc_mail1 = ""
to_addr1 = "tan.mai@terralogic.com"
cc_mail0 = ""
...
def run_test(build_version=""):
    ...
    if week < 10:
        ...
        weekReport = str(week)
    report_link = "\\\\samba.zsc11.intel.com\\nfs\\site\\proj\\CFG\\scratch2\\tanmaix\\report\\" + "html_report"  + current_day + "_" + current_time
    os.system("xcopy html_report " + report_link  + " /E/H/C/I")

    subject = "Retest GUI Automation Test Report W" + str(weekReport) + "." + str(datetime.today().year)
    content = ""
